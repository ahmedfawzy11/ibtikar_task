...
import 'package:ibtikar_task/Constants/api_constants.dart';
import 'package:ibtikar_task/Model/credits.dart';
import 'package:ibtikar_task/Model/function.dart';
import 'package:ibtikar_task/Model/genres.dart';
import 'package:ibtikar_task/Model/movie.dart';
import 'package:ibtikar_task/Screens/castncrew.dart';
import 'package:ibtikar_task/Screens/genremovies.dart';
import 'package:ibtikar_task/Screens/movie_detail.dart';
...
class _DiscoverMoviesState extends State<DiscoverMovies> {
  ...
  void initState() {
    super.initState();
    fetchMovies(Endpoints.discoverMoviesUrl(1)).then(
      (value) {
        setState(
          () {
            moviesList = value;
...
class _GenreListState extends State<GenreList> {
  ...
  void initState() {
    ...
    Future.delayed(
      Duration.zero,
      () {
        widget.totalGenres.forEach(
          (valueGenre) {
            widget.genres.forEach(
              (genre) {
...
class _SearchMovieWidgetState extends State<SearchMovieWidget> {
  ...
  void initState() {
    super.initState();
    fetchMovies(Endpoints.movieSearchUrl(widget.query!)).then(
      (value) {
        setState(
          () {
            moviesList = value;
